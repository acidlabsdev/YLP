...
- **Material Design Symbols** - © Google inc., licensed under [Apache-2.0](https://opensource.org/licenses/Apache-2.0). YLP uses a self-generated stripped version (~250KB)
- **JetBrains Mono** - © JetBrains s.r.o., licensed under [SIL Open Font License v1.1](https://openfontlicense.org/). Font included as is.
- **JetBrains Mono Bold** - © JetBrains s.r.o., licensed under [SIL Open Font License v1.1](https://openfontlicense.org/). Font included as is.
